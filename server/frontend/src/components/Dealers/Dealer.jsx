  ...
  return (
    <div style={{ margin: "20px" }}>
        ...
        <div style={{ marginTop: "10px" }}>
            <h1 style={{ color: "grey" }}>
                {dealer.full_name || "Dealer not found"} {postReview}
            </h1>
            <h4 style={{ color: "grey" }}>
                {dealer.city || "Unknown City"}, {dealer.address || "Unknown Address"},
                Zip - {dealer.zip || "Unknown Zip"}, {dealer.state || "Unknown State"}
            </h4>
        </div>
